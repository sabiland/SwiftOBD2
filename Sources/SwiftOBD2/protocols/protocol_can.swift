...
private let CAN_ID_BITS_11 = 11
private let CAN_ID_BITS_29 = 29
...
extension CANProtocol {
    func parseDefault(_ lines: [String], idBits: Int) throws
        -> [MessageProtocol]
    {
...
class ISO_15765_4_11bit_500k: CANProtocol {
    ...
    func parse(_ lines: [String]) throws -> [MessageProtocol] {
        try parseDefault(lines, idBits: CAN_ID_BITS_11)
    }
}
...
class ISO_15765_4_29bit_500k: CANProtocol {
    ...
    func parse(_ lines: [String]) throws -> [MessageProtocol] {
        try parseDefault(lines, idBits: CAN_ID_BITS_29)
    }
}
